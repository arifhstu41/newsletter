                            ...
                            <div class="box-form-signup">
                                <form method="POST" action="{{ route('customer.login.post') }}">
                                    ...
                                    <div class="form-group">
                                        <input type="email" @class(['form-control', 'is-invalid' => $errors->has('email'), 'input-green-bd' => ! $errors->has('email')]) placeholder="{{ __('Your email') }} *" name="email" value="{{ BaseHelper::clean(old('email')) }}" autofocus>
                                        @error('email')
