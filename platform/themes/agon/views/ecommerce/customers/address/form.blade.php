{!! Form::open(['url' => $url, 'method' => 'POST']) !!}
    ...
    <div class="form-content">
        ...
        <div class="mb-3">
            ...
            @else
                <select name="city" class="form-select @if ($errors->has('city')) is-invalid @endif" id="city" data-type="city" data-using-select2="false" data-placeholder="{{ __('Select city...') }}" data-url="{{ route('ajax.cities-by-state') }}">
